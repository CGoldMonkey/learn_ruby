...
#
# (There are a few more rules for edge cases, and there are regional variants too, but that should 
# be enough to understand the tests.)
#
...
describe "#translate" do
  ...
  it "translates many words" do
    ...
    # Test-driving bonus:
  # * write a test asserting that capitalized words are still capitalized (but with a 
  # different initial capital letter, of course)
  it "translates words with capital letters" do
    s = translate("Kitty cat")
    expect(s).to eq("Ittykay atcay")
  end

  it 'translates capitalized words' do
    s = translate("Mary Poppins")
    expect(s).to eq("Arymay Oppinspay")
  end
